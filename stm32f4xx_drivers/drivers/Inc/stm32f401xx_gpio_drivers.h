...
typedef struct
{
	...
	uint8_t GPIO_PuPdControl;      /*!<  possible values from @GPIO_PUPD  >*/
	uint8_t GPIO_PinOPType;        /*!<  possible values from @GPIO_OUTPUT_TYPE  >*/
	uint8_t GPIO_PinAltFunMode;    /*!<  possible values from @GPIO_PIN_ALT_FUNCTION  >*/
}GPIO_PinConfig_t;
/*
...
/*
 * GPIO pin pull up pull down configuration marcros
 * @GPIO_PUPD
 */
